...
class _$_TopicDto implements _TopicDto {
  ...
  @override
  String toString() {
    return 'TopicDto(id: $id, name: $name, shortDescription: $shortDescription, longDescription: $longDescription, url: $url, imageUrl: $imageUrl, followed: $followed)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, shortDescription,
      longDescription, url, imageUrl, followed);
...
abstract class _TopicDto implements TopicDto {
  factory _TopicDto(
      ...
      final String url,
      final String imageUrl,
      final bool followed}) = _$_TopicDto;
